...
class ValidatorModel extends Html4PhpSite {
    ...
    public function isMatch($type, $subject) {
        return $this->validator->isMatch($type, $subject);
    }

    public function isMatchWithRefArray($type, $subject, &$matchArray) {
        return $this->validator->isMatchWithRefArray($type, $subject, $matchArray);
    }
